...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../eth_std_main_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is eth_std_main_system
SOPC_NAME := eth_std_main_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x800e000
SOPC_SYSID_FLAG += --sidp=0x800e000
ELF_PATCH_FLAG  += --sidp 0x800e000

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1344838623
SOPC_SYSID_FLAG += --timestamp=1344838623
ELF_PATCH_FLAG  += --timestamp 1344838623
...
# setting hal.stderr is peripheral_subsystem_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev peripheral_subsystem_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is peripheral_subsystem_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev peripheral_subsystem_jtag_uart
...
# setting hal.stdout is peripheral_subsystem_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev peripheral_subsystem_jtag_uart
