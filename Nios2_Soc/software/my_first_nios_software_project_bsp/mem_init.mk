...
MEM_0 := eth_std_main_system_ethernet_subsystem_descriptor_memory
$(MEM_0)_NAME := ethernet_subsystem_descriptor_memory
...
$(MEM_0)_START := 0x0800c000
$(MEM_0)_END := 0x0800dfff
$(MEM_0)_HIERARCHICAL_PATH := ethernet_subsystem.descriptor_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: ethernet_subsystem_descriptor_memory
ethernet_subsystem_descriptor_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
